...
class WAA_Assistant {
    ...
    private function build_messages($user_message, $context, $history, $language) {
        ...
        $system_prompt .= "\n\nИспользуй следующую информацию о товарах для ответа на вопросы покупателя. Не указывай ссылки в текстовом ответе - карточки товаров с ссылками будут показаны автоматически. Если среди найденных товаров нет подходящих - честно скажи об этом.\n\nДоступные товары и информация:\n" . $context;
